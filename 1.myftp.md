...
sequenceDiagram
    ...
    Note right of Server: Directory exists. Change the directory accessed by this client.
```
...
<table>
    ...
    <tr>
        <td>Cd</td>
        <td>测试CHANGE_DIR_REQUEST</td>
        <td>10</td>
        <td>是</td>
        <td>更改 Server 的工作目录</td>
    </tr>
    <tr>
        <td>SHA256</td>
        <td>测试SHA_REQUEST</td>
    ...
    <tr>
        ...
        <td>10</td>
        <td>否</td>
        <td>更改 Server 的工作目录并获取新目录下的文件列表</td>
    </tr>
    <tr>
