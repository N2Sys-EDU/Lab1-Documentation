...
<table>
    ...
    <tr>
        ...
        <td>0</td>
        <td>是</td>
        <td>4 个 Clients 同时获取同一个文件，用于辅助检查并发文件下载功能</td>
    </tr>
    <tr>
        <td>MultiPut</td>
        ...
        <td>0</td>
        <td>是</td>
        <td>4 个 Clients 同时上传不同文件，用于辅助检查并发文件上传功能</td>
    </tr>
    <tr>
        <td>GetBig</td>
        <td>测试GET_REQUEST</td>
    ...
    <tr>
        ...
        <td>10</td>
        <td>否</td>
        <td>4 个 Clients 分别进入不同的子目录，每个子目录包含 4 个随机生成的文件，要求每个 Client 获取到对应目录的正确文件列表</td>
    </tr>
    <tr>
